...
class TravelAgent:
    ...
    def local_tour_guide(self):
        return Agent(
            role="Local Tour Guid",
            backstory=dedent(f"""Knowledgeable local guide with extensive information about the city, it's attrations and customs """),
